...
namespace LearningKit.Controllers
{
    public class AzureSearchController : Controller
    {
        ...
        private static List<string> InitializeFilterQueries()
        {
            ...
            {
                // Restricts search results to pages (products) of the 'dancinggoat.coffee' type
                // This filter is included only to make the associated sample scenario simpler to implement
