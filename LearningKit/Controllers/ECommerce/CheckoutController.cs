...
namespace LearningKit.Controllers
{
    public class CheckoutController : Controller
    {
        ...
        private SelectList CreateShippingOptionList(ShoppingCartInfo cart)
        {
            ...
            IEnumerable<ShippingOptionInfo> shippingOptions = shippingOption.GetBySite(SiteContext.CurrentSiteID, true);
        ...
        public ActionResult DeliveryDetailsAddressSelector()
        {
            ...
            SelectList shippingOptions = new SelectList(shippingOption.GetBySite(SiteContext.CurrentSiteID, true).ToList(), "ShippingOptionID", "ShippingOptionDisplayName");
        ...
        public ActionResult DeliveryDetails(DeliveryDetailsViewModel model)
        {
            ...
            SelectList shippingOptions = new SelectList(
                    shippingOption.GetBySite(
                            SiteContext.CurrentSiteID, true).ToList(),
                    "ShippingOptionID",
        ...
        private IEnumerable<PaymentOptionInfo> GetApplicablePaymentMethods(ShoppingCartInfo cart)
        {
            ...
            IEnumerable<PaymentOptionInfo> enabledPaymentMethods = paymentOption.GetBySite(SiteContext.CurrentSiteID, true).ToList();
